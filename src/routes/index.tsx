    ...
    <main id="top" className="overflow-x-clip bg-background text-foreground">
      ...
      <section className="relative min-h-[calc(100svh-5rem)] border-b border-border lg:min-h-[calc(100vh-5rem)]">
        <div className="mx-auto grid min-h-[calc(100svh-5rem)] max-w-[90rem] lg:grid-cols-[1.08fr_0.92fr]">
          ...
          <div className="hero-visual relative min-h-[48rem] overflow-hidden lg:min-h-0">
             <img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=1200&q=80" alt="Premium spa treatment room in a serene luxury med spa" width={1200} height={1600} fetchPriority="high" className="absolute inset-0 size-full object-cover" />
      ...
      <section id="about" className="scroll-mt-20 bg-sage py-24 lg:py-0">
        <div className="mx-auto grid max-w-[90rem] lg:grid-cols-2">
           <div className="hero-visual relative min-h-[34rem] lg:min-h-[52rem]"><img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=1200&q=80" alt="Premium spa treatment room used in the Sofia Jofiel med spa visual language" width={1200} height={912} loading="lazy" className="absolute inset-0 size-full object-cover" /><div className="absolute bottom-6 left-6 border border-primary-foreground/30 bg-foreground/75 px-5 py-4 text-primary-foreground backdrop-blur-sm"><p className="text-[0.65rem] uppercase">The Sofia Jofiel standard</p><p className="mt-1 font-display text-xl">Subtle. Personal. Assured.</p></div></div>
