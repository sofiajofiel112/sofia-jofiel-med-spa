    ...
    <main id="top" className="overflow-x-clip bg-background text-foreground">
      ...
      <section className="relative min-h-[calc(100svh-5rem)] border-b border-border lg:min-h-[calc(100vh-5rem)]">
        <div className="mx-auto grid min-h-[calc(100svh-5rem)] max-w-[90rem] lg:grid-cols-[1.08fr_0.92fr]">
          ...
          <div className="hero-visual relative min-h-[48rem] overflow-hidden lg:min-h-0">
             <img src="https://unsplash.com/photos/woman-receiving-facial-treatment-with-metal-tools-4pDlorrrOOM" alt="Premium spa treatment room in a serene luxury med spa" width={1200} height={1600} fetchPriority="high" className="absolute inset-0 size-full object-cover" />
      ...
      <section id="about" className="scroll-mt-20 bg-sage py-24 lg:py-0">
        <div className="mx-auto grid max-w-[90rem] lg:grid-cols-2">
           <div className="hero-visual relative min-h-[34rem] lg:min-h-[52rem]"><img src="https://www.istockphoto.com/photo/what-a-pleasure-gm486873186-73769039?utm_source=unsplash&utm_medium=affiliate&utm_campaign=srp_photos_bottom&utm_content=https%3A%2F%2Funsplash.com%2Fs%2Fphotos%2Fafrican-spa&utm_term=african+spa%3A%3A%3A%3A8833d34e-bd24-4151-b075-4f3087463556" width={1200} height={912} loading="lazy" className="absolute inset-0 size-full object-cover" /><div className="absolute bottom-6 left-6 border border-primary-foreground/30 bg-foreground/75 px-5 py-4 text-primary-foreground backdrop-blur-sm"><p className="text-[0.65rem] uppercase">The Sofia Jofiel standard</p><p className="mt-1 font-display text-xl">Subtle. Personal. Assured.</p></div></div>
